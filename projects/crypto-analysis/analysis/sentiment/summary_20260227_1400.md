...
**Period:** 2026-02-27 12:00 - 14:00 (Asia/Shanghai)
...
| Metric | Value | Signal |
|--------|-------|--------|
| Funding Rate | -0.0010% | Neutral |
| OI Change (1h) | +0.0% | Stable |
| L/S Ratio | 1.83 | Balanced |
...
| Metric | Value | Signal |
|--------|-------|--------|
| Funding Rate | 0.0014% | Neutral |
| OI Change (1h) | +0.0% | Stable |
| L/S Ratio | 1.77 | Balanced |
| Liquidation Risk | Low | - |
